...
const Values = () => {
    ...
    return (
        <section id="mengapa-kami" className="py-32 md:py-40 bg-[#FBF9F7] text-navy overflow-hidden relative scroll-mt-20">
            {/* Subtle background pattern - Blue Aura glow inspired by Twine */}
            <div className="absolute inset-0 opacity-[0.3] pointer-events-none">
                <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-navy/[0.04] rounded-full blur-[150px] translate-x-1/3 -translate-y-1/4"></div>
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gold/[0.03] rounded-full blur-[120px] -translate-x-1/4 translate-y-1/4"></div>
            </div>
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="mb-24 md:mb-32 max-w-3xl">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <span className="label-overline text-gold">Filosofi Kami</span>
                    </div>
                    <h2 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter leading-[0.9] uppercase mb-10 text-navy">
                        ...
                        <span className="text-gold">pengalaman selamanya.</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
                    ...
                    <div className="lg:col-span-7">
                        <div className="grid sm:grid-cols-2 gap-6">
                            {values.map((val, i) => (
                                <div key={i} className="group p-8 bg-white border border-navy/5 rounded-sm hover:border-gold/30 hover:shadow-[0_20px_40px_-15px_rgba(30,58,138,0.05)] transition-all duration-700">
                                    <div className="flex flex-col gap-6">
                                        <div className="w-12 h-12 rounded-full border border-navy/5 flex items-center justify-center text-gold group-hover:bg-gold group-hover:text-white group-hover:border-gold transition-all duration-500 bg-[#FBF9F7]">
                                            {val.icon}
                                        </div>
                                        <div>
                    ...
                    <div className="lg:col-span-5">
                        <div className="bg-navy p-12 md:p-16 rounded-sm h-full flex flex-col justify-between relative overflow-hidden group shadow-2xl shadow-navy/20">
                            {/* Card decoration */}
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl md:text-3xl font-bold mb-8 leading-[1.2] text-white tracking-tight">
                                    Regulasi bisa <span className="text-gold italic font-serif font-light lowercase">rumit.</span> Prosedur bisa berubah sewaktu-waktu.
                                </h3>
                            ...
                            <button className="relative z-10 w-full py-6 bg-gold text-navy rounded-sm font-bold uppercase tracking-[0.2em] text-[10px] hover:bg-white hover:text-navy transition-all flex items-center justify-center gap-4 active:scale-[0.98] shadow-xl shadow-gold/20">
