...
const WhatsAppFloat = () => {
    ...
    return (
        ...
        >
            ...
            >
                {/* Tooltip */}
                <span className="absolute right-[110%] mr-6 glass-effect text-navy text-[10px] font-bold uppercase tracking-[0.2em] px-5 py-3 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-4 group-hover:translate-x-0 whitespace-nowrap pointer-events-none shadow-2xl border-navy/5">
                    Konsultasi Gratis
                </span>
